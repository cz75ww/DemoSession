...
##### Requirements:
* Create AWS SNS topic in order to send the email with the notification. - [How2CreateSNSTopic](https://docs.aws.amazon.com/sns/latest/dg/sns-create-topic.html)
